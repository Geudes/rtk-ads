...
// import { addAds } from "../../../entitites/ads/models/ads-slice"
// import { setError, setLoading, updateAds } from "../models/ads-slice"
...
// function AdsForm({ad, closeFormHandler}) {
...
//         const res = await AdsApi.update(ad.id, data)
//         if('error' in res) {
//             dispatch(setError(res.error))
//             dispatch(setLoading(false))
//         } else {
